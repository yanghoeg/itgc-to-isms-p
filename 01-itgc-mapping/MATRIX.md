...
| 2.5.3 | 사용자 인증 | 직접 | APD | — | [→](./1-direct/apd/2.5.3-사용자-인증.md) |
| 2.5.4 | 비밀번호 관리 | 직접 | APD | — | [→](./1-direct/apd/2.5.4-비밀번호-관리.md) |
| 2.5.5 | 특수 계정 및 권한 관리 | 직접 | APD | — | [→](./1-direct/apd/2.5.5-특수-계정-및-권한-관리.md) |
| 2.5.6 | 접근권한 검토 | 직접 | APD | — | [→](./1-direct/apd/2.5.6-접근권한-검토.md) |
| 2.6.1 | 네트워크 접근 | 직접 | APD | — | [→](./1-direct/apd/2.6.1-네트워크-접근.md) |
| 2.6.2 | 정보시스템 접근 | 직접 | APD | — | [→](./1-direct/apd/2.6.2-정보시스템-접근.md) |
| 2.6.3 | 응용프로그램 접근 | 직접 | APD | — | [→](./1-direct/apd/2.6.3-응용프로그램-접근.md) |
| 2.6.4 | 데이터베이스 접근 | 직접 | APD | — | [→](./1-direct/apd/2.6.4-데이터베이스-접근.md) |
...
| 2.8.3 | 시험과 운영 환경 분리 | 직접 | PD | — | [→](./1-direct/pd/2.8.3-시험과-운영-환경-분리.md) |
| 2.8.4 | 시험 데이터 보안 | 직접 | PD | — | (작성 예정) |
| 2.8.5 | 소스 프로그램 관리 | 직접 | PD | — | (작성 예정) |
| 2.8.6 | 운영환경 이관 | 직접 | PC+PD | — | (작성 예정) |
| 2.9.1 | 변경관리 | 직접 | PC | — | [→](./1-direct/pc/2.9.1-변경관리.md) |
...
- 작성 완료: **12 / 101** (2.5.1, 2.5.2, 2.5.3, 2.5.4, 2.5.5, 2.5.6, 2.6.1, 2.6.2, 2.6.3, 2.6.4, 2.8.3, 2.9.1)
