...
- **소형·중형 회계법인** — 클라이언트 ITGC 감사 의뢰는 들어오는데 빅4 메소돌로지를 참조하기 어려운 IT 감사팀
...
- **빅4 메소돌로지 + 중소형 회계법인 현실** 양쪽을 모두 경험. 이상적 절차가 아니라 **실제 적용 가능한 절차**로 설계
- **회계감사 시각**으로 ITGC를 봅니다. 보안 컨설팅과 달리 외부감사인이 무엇을 검증하는지를 기준으로 통제를 설계합니다
- **KISA 1차 자료 직접 검증**. 빅4 비공개 메소돌로지 인용 없음, 한국 비금융 시장 현실에 맞는 권고
...
- **회계감사 실무 적용 시** — 소속 회계법인의 메소돌로지와 KISA 공식 안내서, 회계감사기준서를 우선 참조하십시오. 본 레포는 보조 참고 자료입니다.
...
- 인물명·구체 날짜 → 모두 제거
- 빅4 회계법인의 구체적 메소돌로지 절차 → 미공개 (NDA 잠재 위반 방지)
